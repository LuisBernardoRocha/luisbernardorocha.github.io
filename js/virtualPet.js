...
//// "Progression" of time. Ages cat as timer moves forward.
function makeOlder() {
...
///Timer which progresses game
function moveTime() {
    kitty.makeOlder();
    theTimeOut = setTimeout("moveTime();", 3000);
}   
...
///Click cat, it meows
      ...
      $('.meowmeow').click(function(){
        ...
        audioElement.setAttribute('src', 'audio/meow.wav');
